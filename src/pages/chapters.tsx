        ...
        <div className="container">
          ...
          <div className={styles.chaptersContainer}>
            {chaptersData.map((chapter) => (
              <div key={chapter.name} className={styles.chapterCard}>
                <div className={styles.chapterHeader}>
                  <Heading as="h2" className={styles.chapterTitle}>
                    {chapter.name}
                  </Heading>
                  {chapter.isHomeChapter && <span className={styles.homeBadge}>Home Chapter</span>}
                </div>
                <div className={styles.chapterContent}>
                  ...
                  <div className={styles.chapterDetails}>
                    ...
                    <div className={styles.detailItem}>
                      <strong>🗓️ Meetups:</strong> {chapter.meetupSchedule}
                    </div>
                    <div className={styles.detailItem}>
                      <strong>👥 Focus:</strong> {chapter.focus.join(', ')}
                    </div>
                      ...
                      <div className={styles.detailItem}>
                        ...
                        <div className={styles.officersList}>
                          {chapter.officers.map((officer) => (
                            <div key={officer.name} className={styles.officer}>
          ...
          <div className={styles.ctaSection}>
            <div className={styles.ctaCard}>
              ...
              <p className={styles.ctaDescription}>
                Interested in starting a MeshEnvy chapter in your area? We'd love to help you build a local Meshtastic
                community! Whether you're in a major city or a rural area, there's a place for your chapter in our
                network.
              </p>
              <div className={styles.ctaPoints}>
                <div className={styles.ctaPoint}>
                  <span className={styles.ctaIcon}>🤝</span>
                  <div>
                    <strong>Connect Locally</strong>
                    <p>Bring together Meshtastic enthusiasts in your community</p>
                  </div>
                </div>
                <div className={styles.ctaPoint}>
                  <span className={styles.ctaIcon}>📚</span>
                  <div>
                    ...
                    <p>Organize workshops and learning sessions</p>
                  </div>
                </div>
                <div className={styles.ctaPoint}>
                  <span className={styles.ctaIcon}>🌐</span>
                  <div>
                    <strong>Grow the Network</strong>
                    <p>Build mesh infrastructure in your area</p>
                  </div>
                </div>
              </div>
