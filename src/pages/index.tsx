    ...
    <header className={clsx('hero hero--primary', styles.heroBanner)}>
      <div className="container">
        ...
        <div className={styles.buttons}>
          <Link className="button button--secondary button--lg" to="/fundraiser">
          ...
          <Link className="button button--secondary button--lg" to="https://discord.gg/gRWAccbEWN">
          ...
          <Link className="button button--secondary button--lg" to="https://meshenvy.kit.com/9a76ddcad8">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
...
export default function Home(): ReactNode {
  const { siteConfig } = useDocusaurusContext()
  return (
    <Layout title={`Join ${siteConfig.title}`} description="Building Meshtastic across Nevada">
      <HomepageHeader />
      <main>
        <HomepageFeatures />
      </main>
